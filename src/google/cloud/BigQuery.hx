...
@:jsRequire("google-cloud", "bigquery") extern class BigQuery {
	...
	**/
	@:overload(function(id:String, callback:js.Error -> google.cloud.bigquery.Dataset -> Dynamic -> Void):Void { })
	function createDataset(id:String, options:Dynamic, callback:js.Error -> google.cloud.bigquery.Dataset -> Dynamic -> Void):Void;
	/**
		<p>Create a reference to a dataset.</p>
	**/
	function dataset(id:String):google.cloud.bigquery.Dataset;
	/**
		<p>List all or some of the datasets in your project.</p>
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.bigquery.Dataset> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var maxResults : Float; /**
		<ul> <li>Token returned from a previous call, to request the next page of results.</li> </ul> 
	**/
	var pageToken : String; }, callback:js.Error -> Array<google.cloud.bigquery.Dataset> -> Dynamic -> Dynamic -> Void):Void;
	/**
		<p>Get all of the jobs from your project.</p>
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.bigquery.Job> -> Dynamic -> Dynamic -> Void):Void { })
	@:overload(function():Void { })
	...
	**/
	@:optional
	var stateFilter : String; }, callback:js.Error -> Array<google.cloud.bigquery.Job> -> Dynamic -> Dynamic -> Void):Void;
	/**
		<p>Create a reference to an existing job.</p>
	**/
	function job(id:String):google.cloud.bigquery.Job;
	/**
	...
	**/
	@:optional
	var destination : google.cloud.bigquery.Table; /**
		<ul> <li>A query string, following the BigQuery query syntax, of the query to execute.</li> </ul> 
	**/
	var query : String; }>, callback:js.Error -> google.cloud.bigquery.Job -> Dynamic -> Void):Void;
}