...
@:jsRequire("google-cloud", "dns.zone") extern class Zone {
	/**
	...
	**/
	function addRecords(record:haxe.extern.EitherType<Array<google.cloud.dns.Record>, google.cloud.dns.Record>):Void;
	/**
		<p>Create a reference to a change object in this zone.</p>
	**/
	function change(id:String):google.cloud.dns.Change;
	/**
	...
	**/
	var add : haxe.extern.EitherType<Array<google.cloud.dns.Record>, google.cloud.dns.Record>; /**
	...
	**/
	var delete : haxe.extern.EitherType<Array<google.cloud.dns.Record>, google.cloud.dns.Record>; }, callback:js.Error -> google.cloud.dns.Change -> Dynamic -> Void):Void;
	/**
	...
	**/
	function deleteRecords(record:haxe.extern.EitherType<String, haxe.extern.EitherType<Array<google.cloud.dns.Record>, google.cloud.dns.Record>>):Void;
	/**
	...
	**/
	function empty(callback:js.Error -> google.cloud.dns.Change -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.dns.Change> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var sort : String; }, callback:js.Error -> Array<google.cloud.dns.Change> -> Dynamic -> Dynamic -> Void):Void;
	/**
		<p>Get the list of records for this zone.</p>
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.dns.Record> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var type : String; }, callback:js.Error -> Array<google.cloud.dns.Record> -> Dynamic -> Dynamic -> Void):Void;
	/**
		<p>Copy the records from a zone file into this zone.</p>
	**/
	@:native("import")
	function import_(localPath:String, callback:js.Error -> google.cloud.dns.Change -> Dynamic -> Void):Void;
	/**
	...
	**/
	var ttl : Float; }):google.cloud.dns.Record;
	/**
	...
	**/
	function replaceRecords(recordTypes:haxe.extern.EitherType<Array<String>, String>, newRecords:haxe.extern.EitherType<Array<google.cloud.dns.Record>, google.cloud.dns.Record>, callback:js.Error -> google.cloud.dns.Change -> Dynamic -> Void):Void;
}