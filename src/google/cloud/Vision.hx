...
@:jsRequire("google-cloud", "vision") extern class Vision {
	...
	**/
	@:overload(function(images:haxe.extern.EitherType<Array<google.cloud.storage.File>, haxe.extern.EitherType<google.cloud.storage.File, haxe.extern.EitherType<Array<js.node.buffer.Buffer>, haxe.extern.EitherType<js.node.buffer.Buffer, haxe.extern.EitherType<Array<String>, String>>>>>, callback:js.Error -> haxe.extern.EitherType<Array<{ /**
	...
	**/
	...
	function detect(images:haxe.extern.EitherType<Array<google.cloud.storage.File>, haxe.extern.EitherType<google.cloud.storage.File, haxe.extern.EitherType<Array<js.node.buffer.Buffer>, haxe.extern.EitherType<js.node.buffer.Buffer, haxe.extern.EitherType<Array<String>, String>>>>>, options:haxe.extern.EitherType<{ /**
