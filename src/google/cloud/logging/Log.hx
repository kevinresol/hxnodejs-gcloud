...
@:jsRequire("google-cloud", "logging.log") extern class Log {
	...
	**/
	@:overload(function(entry:haxe.extern.EitherType<Array<google.cloud.logging.Entry>, google.cloud.logging.Entry>, callback:js.Error -> Dynamic -> Void):Void { })
	function write(entry:haxe.extern.EitherType<Array<google.cloud.logging.Entry>, google.cloud.logging.Entry>, options:{ /**
