...
@:jsRequire("google-cloud", "dns") extern class DNS {
	...
	**/
	@:optional
	var description : String; }, callback:js.Error -> google.cloud.dns.Zone -> Dynamic -> Void):Void;
	/**
		<p>Gets a list of managed zones for the project.</p>
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.dns.Zone> -> Dynamic -> Void):Void { })
	...
	**/
	var pageToken : String; }, callback:js.Error -> Array<google.cloud.dns.Zone> -> Dynamic -> Void):Void;
	/**
		<p>Create a zone object representing a managed zone.</p>
	**/
	function zone(name:String):google.cloud.dns.Zone;
}