...
@:jsRequire("google-cloud", "compute.zone") extern class Zone {
	...
	**/
	function autoscaler(name:String):google.cloud.compute.Autoscaler;
	/**
	...
	**/
	var target : String; }, callback:js.Error -> google.cloud.compute.Autoscaler -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:optional
	var os : String; }, callback:js.Error -> google.cloud.compute.Disk -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
	...
	**/
	var ports : Dynamic; }, callback:js.Error -> google.cloud.compute.InstanceGroup -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:optional
	var tags : Array<String>; }, callback:js.Error -> google.cloud.compute.VM -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
		<p>Get a reference to a Google Compute Engine disk in this zone.</p>
	**/
	function disk(name:String):google.cloud.compute.Disk;
	/**
	...
	**/
	function instanceGroup(name:String):google.cloud.compute.InstanceGroup;
	/**
		<p>Get a reference to a Google Compute Engine machine type.</p>
	**/
	function machineType(name:String):google.cloud.compute.MachineType;
	/**
	...
	**/
	function vm(name:String):google.cloud.compute.VM;
}