...
@:jsRequire("google-cloud", "compute.instance-group") extern class InstanceGroup {
	/**
	...
	**/
	function add(vms:haxe.extern.EitherType<Array<google.cloud.compute.VM>, google.cloud.compute.VM>, callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.compute.VM> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var running : Bool; }, callback:js.Error -> Array<google.cloud.compute.VM> -> Dynamic -> Dynamic -> Void):Void;
	/**
		<p>Remove one or more VMs from this instance group.</p>
	**/
	function remove(vms:haxe.extern.EitherType<Array<google.cloud.compute.VM>, google.cloud.compute.VM>, callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
		<p>Set the named ports for this instance group.</p>
	**/
	@:overload(function(ports:Dynamic):Void { })
	function setPorts(ports:Dynamic, callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
}