...
@:jsRequire("google-cloud", "compute.vm") extern class VM {
	...
	**/
	@:overload(function(disk:google.cloud.compute.Disk, callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void { })
	function attachDisk(disk:google.cloud.compute.Disk, options:{ /**
		<ul> <li>Attach the disk in read-only mode. (Alias for <code>options.mode = READ_ONLY</code>)</li> </ul> 
	**/
	var readOnly : Bool; }, callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(deviceName:haxe.extern.EitherType<String, google.cloud.compute.Disk>):Void { })
	function detachDisk(deviceName:haxe.extern.EitherType<String, google.cloud.compute.Disk>, callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function():Void { })
	function reset(callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
	...
	**/
	...
	function setTags(tags:Array<String>, fingerprint:String, callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
		<p>Start the instance.</p>
	**/
	@:overload(function():Void { })
	function start(callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
		<p>Stop the instance.</p>
	**/
	@:overload(function():Void { })
	function stop(callback:js.Error -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
}