...
@:jsRequire("google-cloud", "compute.region") extern class Region {
	...
	**/
	function address(name:String):google.cloud.compute.Address;
	/**
		<p>Create an address in this region.</p>
	**/
	@:overload(function(name:String, callback:js.Error -> google.cloud.compute.Address -> google.cloud.compute.Operation -> Dynamic -> Void):Void { })
	function createAddress(name:String, options:Dynamic, callback:js.Error -> google.cloud.compute.Address -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
	...
	**/
	var network : haxe.extern.EitherType<String, google.cloud.compute.Network>; /**
	...
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.compute.Subnetwork> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var maxResults : Float; /**
		<ul> <li>A previously-returned page token representing part of the larger set of results to view.</li> </ul> 
	**/
	var pageToken : String; }, callback:js.Error -> Array<google.cloud.compute.Subnetwork> -> Dynamic -> Dynamic -> Void):Void;
	/**
	...
	**/
	function subnetwork(name:String):google.cloud.compute.Subnetwork;
}