...
@:jsRequire("google-cloud", "compute.disk") extern class Disk {
	...
	**/
	@:overload(function(name:String, callback:js.Error -> google.cloud.compute.Snapshot -> google.cloud.compute.Operation -> Dynamic -> Void):Void { })
	function createSnapshot(name:String, options:Dynamic, callback:js.Error -> google.cloud.compute.Snapshot -> google.cloud.compute.Operation -> Dynamic -> Void):Void;
	/**
		<p>Delete the disk.</p>
	**/
	@:overload(function():Void { })
