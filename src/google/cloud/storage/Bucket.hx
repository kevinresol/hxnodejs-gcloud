...
@:jsRequire("google-cloud", "storage.bucket") extern class Bucket {
	...
	**/
	@:overload(function(sources:haxe.extern.EitherType<google.cloud.storage.File, Array<String>>, destination:haxe.extern.EitherType<google.cloud.storage.File, String>):Void { })
	function combine(sources:haxe.extern.EitherType<google.cloud.storage.File, Array<String>>, destination:haxe.extern.EitherType<google.cloud.storage.File, String>, callback:js.Error -> google.cloud.storage.File -> Dynamic -> Void):Void;
	/**
	...
	**/
	var address : String; }, callback:js.Error -> google.cloud.storage.Channel -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(name:String):google.cloud.storage.File { })
	...
	**/
	var key : String; }):google.cloud.storage.File;
	/**
		<p>Get File objects for the files currently in the bucket.</p>
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.storage.File> -> Dynamic -> Dynamic -> Void):Void { })
	@:overload(function():Void { })
	...
	**/
	var pageToken : String; /**
		<ul> <li>If true, returns File objects scoped to their versions.</li> </ul> 
	**/
	var versions : Bool; }, callback:js.Error -> Array<google.cloud.storage.File> -> Dynamic -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.storage.File> -> Void):Void { })
	...
	**/
	var force : Bool; }, callback:js.Error -> Array<google.cloud.storage.File> -> Void):Void;
	/**
	...
	**/
	@:overload(function(localPath:String, callback:js.Error -> google.cloud.storage.File -> Dynamic -> Void):Void { })
	...
	**/
	var destination : haxe.extern.EitherType<google.cloud.storage.File, String>; /**
		<ul> <li>A custom encryption key. See <a href="https://cloud.google.com/storage/docs/encryption#customer-supplied">Customer-supplied Encryption Keys</a>.</li> </ul> 
	**/
	...
	**/
	var validation : haxe.extern.EitherType<Bool, String>; }, callback:js.Error -> google.cloud.storage.File -> Dynamic -> Void):Void;
}