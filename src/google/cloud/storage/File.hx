...
@:jsRequire("google-cloud", "storage.file") extern class File {
	...
	**/
	@:overload(function(destination:haxe.extern.EitherType<google.cloud.storage.File, haxe.extern.EitherType<google.cloud.storage.Bucket, String>>):Void { })
	function copy(destination:haxe.extern.EitherType<google.cloud.storage.File, haxe.extern.EitherType<google.cloud.storage.Bucket, String>>, callback:js.Error -> google.cloud.storage.File -> Dynamic -> Void):Void;
	/**
	...
	**/
	function setEncryptionKey(encryptionKey:haxe.extern.EitherType<js.node.buffer.Buffer, String>):google.cloud.storage.File;
	/**
	...
	**/
	@:overload(function(destination:haxe.extern.EitherType<google.cloud.storage.File, haxe.extern.EitherType<google.cloud.storage.Bucket, String>>):Void { })
	function move(destination:haxe.extern.EitherType<google.cloud.storage.File, haxe.extern.EitherType<google.cloud.storage.Bucket, String>>, callback:js.Error -> google.cloud.storage.File -> Dynamic -> Void):Void;
	/**
