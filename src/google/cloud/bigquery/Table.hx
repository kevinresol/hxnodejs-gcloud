...
@:jsRequire("google-cloud", "bigquery.table") extern class Table {
	...
	**/
	@:overload(function(destination:google.cloud.bigquery.Table, callback:js.Error -> google.cloud.bigquery.Job -> Dynamic -> Void):Void { })
	function copy(destination:google.cloud.bigquery.Table, metadata:Dynamic, callback:js.Error -> google.cloud.bigquery.Job -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(destination:google.cloud.storage.File, callback:js.Error -> google.cloud.bigquery.Job -> Dynamic -> Void):Void { })
	function export(destination:google.cloud.storage.File, options:{ /**
	...
	**/
	var gzip : Bool; }, callback:js.Error -> google.cloud.bigquery.Job -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(source:haxe.extern.EitherType<google.cloud.storage.File, String>, callback:js.Error -> google.cloud.bigquery.Job -> Dynamic -> Void):Void { })
	@:native("import")
	function import_(source:haxe.extern.EitherType<google.cloud.storage.File, String>, metadata:{ /**
		<ul> <li>The format the data being imported is in. Allowed options are &quot;CSV&quot;, &quot;JSON&quot;, or &quot;AVRO&quot;.</li> </ul> 
	**/
	var format : String; }, callback:js.Error -> google.cloud.bigquery.Job -> Dynamic -> Void):Void;
	/**
