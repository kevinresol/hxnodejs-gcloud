...
@:jsRequire("google-cloud", "bigquery.dataset") extern class Dataset {
	/**
	...
	**/
	@:overload(function(id:String, callback:js.Error -> google.cloud.bigquery.Table -> Dynamic -> Void):Void { })
	...
	**/
	var schema : haxe.extern.EitherType<Dynamic, String>; }, callback:js.Error -> google.cloud.bigquery.Table -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.bigquery.Table> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var pageToken : String; }, callback:js.Error -> Array<google.cloud.bigquery.Table> -> Dynamic -> Dynamic -> Void):Void;
	/**
	...
	**/
	function table(id:String):google.cloud.bigquery.Table;
}