...
@:jsRequire("google-cloud", "datastore.query") extern class Query {
	...
	**/
	@:overload(function(property:String, value:Dynamic):google.cloud.datastore.Query { })
	function filter(property:String, operator:String, value:Dynamic):google.cloud.datastore.Query;
	/**
	...
	**/
	@:overload(function(property:String):google.cloud.datastore.Query { })
	...
	**/
	var descending : Bool; }):google.cloud.datastore.Query;
	/**
		<p>Group query results by a list of properties.</p>
	**/
	function groupBy(properties:Array<Dynamic>):google.cloud.datastore.Query;
	/**
	...
	**/
	function select(fieldNames:haxe.extern.EitherType<Array<String>, String>):google.cloud.datastore.Query;
	/**
		<p>Set a starting cursor to a query.</p>
	**/
	function start(cursorToken:String):google.cloud.datastore.Query;
	/**
		<p>Set an ending cursor to a query.</p>
	**/
	function end(cursorToken:String):google.cloud.datastore.Query;
	/**
		<p>Set a limit on a query.</p>
	**/
	function limit(n:Float):google.cloud.datastore.Query;
	/**
		<p>Set an offset on a query.</p>
	**/
	function offset(n:Float):google.cloud.datastore.Query;
	/**
		<p>Run the query.</p>
	**/
