...
@:jsRequire("google-cloud", "datastore.transaction") extern class Transaction {
	...
	**/
	@:overload(function(kind:String):google.cloud.datastore.Query { })
	function createQuery(namespace:String, kind:String):google.cloud.datastore.Query;
	/**
		<p>Delete all entities identified with the specified key(s) in the current transaction.</p>
	**/
	function delete(key:haxe.extern.EitherType<Array<google.cloud.datastore.Key>, google.cloud.datastore.Key>):Void;
	/**
	...
	**/
	function run(callback:js.Error -> google.cloud.datastore.Transaction -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(q:google.cloud.datastore.Query, callback:js.Error -> Array<Dynamic> -> { /**
	...
	**/
	...
	@:overload(function(q:google.cloud.datastore.Query):Void { })
	@:overload(function(q:google.cloud.datastore.Query, options:{ /**
		<ul> <li>Specify either <code>strong</code> or <code>eventual</code>. If not specified, default values are chosen by Datastore for the  operation. Learn more about strong and eventual consistency  <a href="https://cloud.google.com/datastore/docs/articles/balancing-strong-and-eventual-consistency-with-google-cloud-datastore">here</a>.</li> </ul> 
	**/
	var consistency : String; /**
		<ul> <li>Maximum API calls to make.</li> </ul> 
	**/
	...
	function runQuery(q:google.cloud.datastore.Query, options:{ /**
		<ul> <li>Specify either <code>strong</code> or <code>eventual</code>. If not specified, default values are chosen by Datastore for the  operation. Learn more about strong and eventual consistency  <a href="https://cloud.google.com/datastore/docs/articles/balancing-strong-and-eventual-consistency-with-google-cloud-datastore">here</a>.</li> </ul> 
	**/
	var consistency : String; /**
		<ul> <li>Maximum API calls to make.</li> </ul> 
