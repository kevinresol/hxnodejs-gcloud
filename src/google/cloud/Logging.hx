...
@:jsRequire("google-cloud", "logging") extern class Logging {
	...
	**/
	var destination : haxe.extern.EitherType<google.cloud.pubsub.Topic, haxe.extern.EitherType<google.cloud.bigquery.Dataset, google.cloud.storage.Bucket>>; /**
		<ul> <li>An advanced logs filter. Only log entries matching the filter are written.</li> </ul> 
	**/
	@:optional
	var filter : String; }, callback:js.Error -> google.cloud.logging.Sink -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(data:haxe.extern.EitherType<String, Dynamic>):google.cloud.logging.Entry { })
	function entry(resource:haxe.extern.EitherType<String, Dynamic>, data:haxe.extern.EitherType<String, Dynamic>):google.cloud.logging.Entry;
	/**
		<p>List the entries in your logs.</p>
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.logging.Entry> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var pageToken : String; }, callback:js.Error -> Array<google.cloud.logging.Entry> -> Dynamic -> Dynamic -> Void):Void;
	/**
		<p>Get the sinks associated with this project.</p>
	**/
	@:overload(function(callback:js.Error -> Array<google.cloud.logging.Sink> -> Dynamic -> Void):Void { })
	...
	**/
	var maxApiCalls : Float; /**
		<ul> <li>Maximum number of results to return.</li> </ul> 
	**/
	var maxResults : Float; }, callback:js.Error -> Array<google.cloud.logging.Sink> -> Dynamic -> Void):Void;
	/**
		<p>Get a reference to a Cloud Logging log.</p>
	**/
	function log(name:String):google.cloud.logging.Log;
	/**
		<p>Get a reference to a Cloud Logging sink.</p>
	**/
	function sink(name:String):google.cloud.logging.Sink;
}