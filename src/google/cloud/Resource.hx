...
@:jsRequire("google-cloud", "resource") extern class Resource {
	...
	**/
	@:overload(function(name:String, callback:js.Error -> google.cloud.resource.Project -> Dynamic -> Void):Void { })
	@:overload(function(name:String):Void { })
	@:overload(function(name:String, options:Dynamic):Void { })
	function createProject(name:String, options:Dynamic, callback:js.Error -> google.cloud.resource.Project -> Dynamic -> Void):Void;
	/**
		<p>Get a list of projects.</p>
	**/
	@:overload(function(callback:js.Error -> google.cloud.resource.Project -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var pageToken : String; }, callback:js.Error -> google.cloud.resource.Project -> Dynamic -> Dynamic -> Void):Void;
	/**
	...
	**/
	function project(id:String):google.cloud.resource.Project;
}