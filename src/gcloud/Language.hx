...
@:jsRequire("google-cloud", "language") extern class Language {
	...
	**/
	@:overload(function(content:haxe.extern.EitherType<gcloud.storage.File, String>, callback:Void -> Dynamic):Void { })
	function annotate(content:haxe.extern.EitherType<gcloud.storage.File, String>, options:{ /**
	...
	**/
	@:overload(function(content:haxe.extern.EitherType<gcloud.storage.File, String>, callback:Void -> Dynamic):Void { })
	function detectEntities(content:haxe.extern.EitherType<gcloud.storage.File, String>, options:{ /**
		<ul> <li><code>UTF8</code>, <code>UTF16</code>, or <code>UTF32</code>. See <a href="https://cloud.google.com/natural-language/reference/rest/v1beta1/EncodingType"><code>EncodingType</code></a>.</li> </ul> 
	**/
	var encoding : String; /**
		<ul> <li>The language of the text.</li> </ul> 
	...
	**/
	@:overload(function(content:haxe.extern.EitherType<gcloud.storage.File, String>, callback:Void -> Dynamic):Void { })
	function detectSentiment(content:haxe.extern.EitherType<gcloud.storage.File, String>, options:{ /**
		<ul> <li><code>UTF8</code>, <code>UTF16</code>, or <code>UTF32</code>. See <a href="https://cloud.google.com/natural-language/reference/rest/v1beta1/EncodingType"><code>EncodingType</code></a>.</li> </ul> 
	**/
	var encoding : String; /**
		<ul> <li>The language of the text.</li> </ul> 
	...
	**/
	function document(config:haxe.extern.EitherType<gcloud.storage.File, haxe.extern.EitherType<String, Dynamic>>):gcloud.language.Document;
	/**
	...
	**/
	@:overload(function(content:haxe.extern.EitherType<gcloud.storage.File, String>):gcloud.language.Document { })
	function html(content:haxe.extern.EitherType<gcloud.storage.File, String>, options:{ /**
		<ul> <li><code>UTF8</code>, <code>UTF16</code>, or <code>UTF32</code>. See <a href="https://cloud.google.com/natural-language/reference/rest/v1beta1/EncodingType"><code>EncodingType</code></a>.</li> </ul> 
	**/
	var encoding : String; /**
		<ul> <li>The language of the text.</li> </ul> 
	**/
	var language : String; }):gcloud.language.Document;
	/**
	...
	**/
	@:overload(function(content:haxe.extern.EitherType<gcloud.storage.File, String>):gcloud.language.Document { })
	function text(content:haxe.extern.EitherType<gcloud.storage.File, String>, options:{ /**
		<ul> <li><code>UTF8</code>, <code>UTF16</code>, or <code>UTF32</code>. See <a href="https://cloud.google.com/natural-language/reference/rest/v1beta1/EncodingType"><code>EncodingType</code></a>.</li> </ul> 
	**/
	var encoding : String; /**
		<ul> <li>The language of the text.</li> </ul> 
