...
@:jsRequire("google-cloud", "pubsub") extern class PubSub {
	...
	**/
	...
	function createTopic(name:String, callback:js.Error -> gcloud.pubsub.Topic -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(topic:haxe.extern.EitherType<String, gcloud.pubsub.Topic>, subName:String, callback:js.Error -> gcloud.pubsub.Subscription -> Dynamic -> Void):Void { })
	function subscribe(topic:haxe.extern.EitherType<String, gcloud.pubsub.Topic>, subName:String, options:{ /**
	...
	**/
	var timeout : Float; }, callback:js.Error -> gcloud.pubsub.Subscription -> Dynamic -> Void):Void;
	/**
