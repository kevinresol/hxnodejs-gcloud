...
@:jsRequire("google-cloud", "prediction") extern class Prediction {
	...
	**/
	@:overload(function(id:String, callback:js.Error -> gcloud.prediction.Model -> Dynamic -> Void):Void { })
	function createModel(id:String, options:{ /**
		<ul> <li>A CSV file to use as training data.</li> </ul> 
	**/
	var data : gcloud.storage.File; /**
	...
	**/
	var type : String; }, callback:js.Error -> gcloud.prediction.Model -> Dynamic -> Void):Void;
	/**
	...
	**/
	function model(id:String):gcloud.prediction.Model;
}