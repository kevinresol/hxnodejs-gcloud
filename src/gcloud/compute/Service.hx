...
@:jsRequire("gcloud.compute.service") extern class Service {
	/**
	...
	**/
	var zone : haxe.extern.EitherType<String, gcloud.compute.Zone>; }, String>, callback:js.Error -> Array<Dynamic> -> Dynamic -> Void):Void;
	/**
