...
@:jsRequire("google-cloud", "bigtable.instance") extern class Instance {
	...
	**/
	@:overload(function(name:String, callback:js.Error -> gcloud.bigtable.Cluster -> js.node.events.EventEmitter -> Dynamic -> Void):Void { })
	...
	**/
	var storage : String; }, callback:js.Error -> gcloud.bigtable.Cluster -> js.node.events.EventEmitter -> Dynamic -> Void):Void;
	/**
		<p>Create a table on your Bigtable instance.</p>
	**/
	@:overload(function(name:String, callback:js.Error -> gcloud.bigtable.Table -> Dynamic -> Void):Void { })
	...
	**/
	var splits : Array<String>; }, callback:js.Error -> gcloud.bigtable.Table -> Dynamic -> Void):Void;
	/**
		<p>Get a reference to a Bigtable Cluster.</p>
	**/
	function cluster(name:String):gcloud.bigtable.Cluster;
	/**
		<p>Get Cluster objects for all of your clusters.</p>
	**/
	@:overload(function(callback:js.Error -> Array<gcloud.bigtable.Cluster> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var pageToken : String; }, callback:js.Error -> Array<gcloud.bigtable.Cluster> -> Dynamic -> Dynamic -> Void):Void;
	/**
		<p>Get Table objects for all the tables in your Compute instance.</p>
	**/
	@:overload(function(callback:js.Error -> Array<gcloud.bigtable.Table> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var view : String; }, callback:js.Error -> Array<gcloud.bigtable.Table> -> Dynamic -> Dynamic -> Void):Void;
	/**
		<p>Get a reference to a Bigtable table.</p>
	**/
	function table(name:String):gcloud.bigtable.Table;
}