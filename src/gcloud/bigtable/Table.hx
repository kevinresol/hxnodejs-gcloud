...
@:jsRequire("google-cloud", "bigtable.table") extern class Table {
	...
	**/
	@:overload(function(name:String, callback:js.Error -> gcloud.bigtable.Family -> Dynamic -> Void):Void { })
	...
	**/
	var union : Bool; }, callback:js.Error -> gcloud.bigtable.Family -> Dynamic -> Void):Void;
	/**
	...
	**/
	function family(name:String):gcloud.bigtable.Family;
	/**
		<p>Get Family objects for all the column familes in your table.</p>
	**/
	function getFamilies(callback:js.Error -> Array<gcloud.bigtable.Family> -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(callback:js.Error -> Array<gcloud.bigtable.Row> -> Void):Void { })
	@:overload(function():Void { })
	@:overload(function(options:{ /**
	...
	**/
	var filter : gcloud.bigtable.Filter; /**
	...
	**/
	var interleave : Bool; /**
		<ul> <li>Maximum number of rows to be returned.</li> </ul> 
	**/
	var limit : Float; }, callback:js.Error -> Array<gcloud.bigtable.Row> -> Void):Void;
	/**
	...
	**/
	function row(key:String):gcloud.bigtable.Row;
	/**
