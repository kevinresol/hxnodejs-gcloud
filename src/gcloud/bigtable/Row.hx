...
@:jsRequire("google-cloud", "bigtable.row") extern class Row {
	...
	**/
	@:overload(function(callback:js.Error -> gcloud.bigtable.Row -> Dynamic -> Void):Void { })
	function create(entry:Dynamic, callback:js.Error -> gcloud.bigtable.Row -> Dynamic -> Void):Void;
	/**
	...
	**/
	@:overload(function(filter:gcloud.bigtable.Filter, onMatch:Array<Dynamic>, callback:js.Error -> Bool -> Void):Void { })
	function filter(filter:gcloud.bigtable.Filter, onMatch:Array<Dynamic>, onNoMatch:Array<Dynamic>, callback:js.Error -> Bool -> Void):Void;
	/**
	...
	**/
	var decode : Bool; }, callback:js.Error -> gcloud.bigtable.Row -> Dynamic -> Void):Void { })
