...
@:jsRequire("google-cloud", "dns.zone") extern class Zone {
	...
	**/
	function addRecords(record:haxe.extern.EitherType<Array<gcloud.dns.Record>, gcloud.dns.Record>):Void;
	/**
	...
	**/
	var add : haxe.extern.EitherType<Array<gcloud.dns.Record>, gcloud.dns.Record>; /**
	...
	**/
	var delete : haxe.extern.EitherType<Array<gcloud.dns.Record>, gcloud.dns.Record>; }, callback:js.Error -> gcloud.dns.Change -> Dynamic -> Void):Void;
	/**
	...
	**/
	function deleteRecords(record:haxe.extern.EitherType<String, haxe.extern.EitherType<Array<gcloud.dns.Record>, gcloud.dns.Record>>):Void;
	/**
	...
	**/
	@:overload(function(callback:js.Error -> Array<gcloud.dns.Change> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var sort : String; }, callback:js.Error -> Array<gcloud.dns.Change> -> Dynamic -> Dynamic -> Void):Void;
	/**
		<p>Get the list of records for this zone.</p>
	**/
	@:overload(function(callback:js.Error -> Array<gcloud.dns.Record> -> Dynamic -> Dynamic -> Void):Void { })
	...
	**/
	var type : String; }, callback:js.Error -> Array<gcloud.dns.Record> -> Dynamic -> Dynamic -> Void):Void;
	/**
	...
	**/
	function replaceRecords(recordTypes:haxe.extern.EitherType<Array<String>, String>, newRecords:haxe.extern.EitherType<Array<gcloud.dns.Record>, gcloud.dns.Record>, callback:js.Error -> gcloud.dns.Change -> Dynamic -> Void):Void;
}